...
export function MethodTab({ run }: { run: RunState }) {
  ...
  return (
    <div className="space-y-5 text-sm leading-relaxed text-slate-300">
      <section>
        <h4 className="mb-1 font-semibold text-slate-100">1 · Plume mask</h4>
      ...
      <section>
        <h4 className="mb-1 font-semibold text-slate-100">2 · Integrated mass enhancement (Varon et al., 2018)</h4>
        ...
        <p className="text-xs text-amber-300/80">α, β are flagged "needs verification" (instrument-specific calibration; EMIT-specific values should be confirmed).</p>
      </section>
      <section>
        <h4 className="mb-1 font-semibold text-slate-100">3 · Monte Carlo uncertainty</h4>
      ...
      <section>
        <h4 className="mb-1 font-semibold text-slate-100">4 · Physics bound</h4>
      ...
      <section>
        <h4 className="mb-1 font-semibold text-slate-100">5 · Regulatory screening rules</h4>
      ...
      <p className="rounded border border-amber-500/30 bg-amber-950/20 p-3 text-xs text-amber-200">All results are satellite-based screening estimates, not enforcement determinations.</p>
    </div>
  );
}
