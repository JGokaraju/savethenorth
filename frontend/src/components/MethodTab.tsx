...
export function MethodTab({ run }: { run: RunState }) {
  ...
  return (
    <div className="space-y-5 text-sm leading-relaxed text-slate-600">
      <section>
        <h4 className="mb-1 font-semibold text-slate-900">1 · Plume mask</h4>
      ...
      <section>
        <h4 className="mb-1 font-semibold text-slate-900">2 · Integrated mass enhancement (Varon et al., 2018)</h4>
        ...
        <p className="text-xs text-amber-700">α, β are flagged "needs verification" (instrument-specific calibration; EMIT-specific values should be confirmed).</p>
      </section>
      <section>
        <h4 className="mb-1 font-semibold text-slate-900">3 · Monte Carlo uncertainty</h4>
      ...
      <section>
        <h4 className="mb-1 font-semibold text-slate-900">4 · Physics bound</h4>
      ...
      <section>
        <h4 className="mb-1 font-semibold text-slate-900">5 · Regulatory screening rules</h4>
      ...
      <p className="rounded border border-amber-200 bg-amber-50 p-3 text-xs text-amber-800">All results are satellite-based screening estimates, not enforcement determinations.</p>
    </div>
  );
}
