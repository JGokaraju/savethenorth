...
export function MethodTab({ run }: { run: RunState }) {
  ...
  return (
    <div className="space-y-5 text-sm leading-relaxed text-muted">
      <section>
        <h4 className="mb-1 font-display text-lg text-ink">1 · Plume mask</h4>
      ...
      <section>
        <h4 className="mb-1 font-display text-lg text-ink">2 · Integrated mass enhancement (Varon et al., 2018)</h4>
      ...
      <section>
        <h4 className="mb-1 font-display text-lg text-ink">3 · Monte Carlo uncertainty</h4>
      ...
      <section>
        <h4 className="mb-1 font-display text-lg text-ink">4 · Physics bound</h4>
      ...
      <section>
        <h4 className="mb-1 font-display text-lg text-ink">5 · Regulatory screening rules</h4>
      ...
      <p className="border-l-2 border-gold/60 bg-panel2 p-3 text-xs text-ink">All results are satellite-based screening estimates, not enforcement determinations.</p>
    </div>
  );
}
